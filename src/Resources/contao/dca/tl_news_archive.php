...
// Palettes
$GLOBALS['TL_DCA']['tl_news_archive']['palettes']['default'] = str_replace('{protected_legend:hide}', '{rssimp_legend:hide},rssimp_imp; {protected_legend:hide}',
